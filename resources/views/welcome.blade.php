        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <!-- Featured blog post-->
                    <div class="card mb-4">
                        <a href="#!"><img class="card-img-top" src="{{asset('uploads/'.$latest_blog->image)}}" alt="..." width="800px" height="350" /></a>
                        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                                <a href="#!"><img class="card-img-top" src="{{asset('uploads/'.$d->image)}}" alt="..." width="750" height="350" /></a>
                                <div class="card-body">
